...
switch ( $Choice)
{
	0
	{
		...
		detachDatabaseISUPT; #Detach IPT database
		stopSQLService; # Stop SQL cluster for IPT without the disks
	}
	1
	{ 
		detachDatabaseISUPT;
...
$intAnswer = $var.popup("Do you want to proceed with Wintel task?",0,"PT system Down",48+4)
If ($intAnswer -ne 6) 
{
